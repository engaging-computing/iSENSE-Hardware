...
public class SensorCompatibility {
	...
	/*
	 * public SensorTypes[] sensors = { SensorTypes.ACCELEROMETER,
	 * SensorTypes.MAGNETIC_FIELD, SensorTypes.AMBIENT_TEMPERATURE,
	 * SensorTypes.PRESSURE, SensorTypes.LIGHT, SensorTypes.ORIENTATION };
	 */
