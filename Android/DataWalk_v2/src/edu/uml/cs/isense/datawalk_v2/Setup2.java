...
public class Setup2 extends Activity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		eidInput.setText(DataWalk.experimentId);
	...
	public void onClick(View v) {
		...
		if (id == R.id.experiment_ok) {
			...
			try {
				...
				Intent iNoQR = new Intent(Setup2.this, NoQr2.class);
