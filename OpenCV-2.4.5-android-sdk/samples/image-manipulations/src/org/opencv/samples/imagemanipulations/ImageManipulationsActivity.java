...
public class ImageManipulationsActivity extends Activity implements CvCameraViewListener2 {
    ...
    public void onCreate(Bundle savedInstanceState) {
       ...
       // mOpenCvCameraView.SetCaptureFormat(Highgui.CV_CAP_ANDROID_GREY_FRAME);
        ...
        // supported res: 720 x 1280, 576 x 720 (slow), 480 x 640, 240 x 320
        // this works fastly!
        //mOpenCvCameraView.setMaxFrameSize(800, 1280);
        
        mOpenCvCameraView.setMaxFrameSize(480, 641);
    ...
    public Mat onCameraFrame(CvCameraViewFrame inputFrame) {
       ...
       // mRgba = inputFrame.gray();
        ...
        Integer strH = inputFrame.rgba().height();
        Integer strW = inputFrame.rgba().width();
        String strWh = strH + " " + strW + " " + mFps.strfps; 
        Core.putText(mRgba, strWh, new Point(200, 200), 
				3/* CV_FONT_HERSHEY_COMPLEX */, 1, new Scalar(255, 0, 0, 255), 2);
