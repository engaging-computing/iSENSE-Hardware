package edu.uml.cs.isense.pinports.eval;
...
enum Operator {
     ...
     * scaleByPow10
     */
    SPT(4, 2, " spt ", Type.ARITHMETIC, Type.ARITHMETIC) {
        @Override
         BigDecimal perform(BigDecimal value1, BigDecimal value2,
                BigDecimal value3) {
            return value1.scaleByPowerOfTen(value2.intValue());
        }
    },

    LN(4,1,"ln",Type.ARITHMETIC, Type.ARITHMETIC){
          @Override
         BigDecimal perform(BigDecimal value1, BigDecimal value2,
                BigDecimal value3) {
