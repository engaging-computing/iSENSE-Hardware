...
public abstract class CameraBridgeViewBase extends SurfaceView implements SurfaceHolder.Callback {
    ...
    protected class CvCameraViewListenerAdapter implements CvCameraViewListener2  {
        ...
        public Mat onCameraFrame(CvCameraViewFrame inputFrame) {
            ...
            Log.e(TAG, "onCameraFrame() called from CvCameraViewListenerAdapter in CameraBridgeViewBase.");
            return result;
        }
        ...
        private int mPreviewFormat = Highgui.CV_CAP_ANDROID_GREY_FRAME;
    ...
    protected Size calculateCameraFrameSize(List<?> supportedSizes, ListItemAccessor accessor, int surfaceWidth, int surfaceHeight) {
        ...
        Log.i(TAG, "Supported frame sizes:");
        for (Object size : supportedSizes) {
        	
            int width = accessor.getWidth(size);
            int height = accessor.getHeight(size);
            Log.i(TAG, "w x h: " + width + " x " + height);
        ...
        Log.i(TAG, "The request max width and height are: " + mMaxWidth + " " + mMaxHeight);
        Log.i(TAG, "The calculated width and height are: " + calcWidth + " " + calcHeight);
